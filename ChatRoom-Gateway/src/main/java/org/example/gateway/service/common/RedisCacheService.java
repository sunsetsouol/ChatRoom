...
public class RedisCacheService {
    ...
    public <K,V> void putAllHashObject(String hashRing, Map<K, V> map) {
        redisTemplate.opsForHash().putAll(hashRing, map);
    }

    public <K,V> Map<K,V> getHashObject(String key, Class<K> kClass, Class<V> vClass) {
